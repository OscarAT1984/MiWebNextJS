      ...
      <body class="m-4">
        <nav className="flex items-center justify-between flex-wrap bg-gray-700 p-4 rounded-md">
          <div className="flex items-center flex-shrink-0 text-white mr-6">
            <span className="font-semibold text-xl tracking-tight">
              {" "}
              Oscar Armando Tellez Covarrubias <br />
              Frontend Developer | Python Dev
            </span>
          </div>
        </nav>
            ...
            <div className="flex items-center text-center lg:text-left px-8 md:px-12 lg:w-1/2">
              <div>
                <h2 className="text-3xl font-semibold text-gray-800 md:text-4xl">
                  Quien es{" "}
                  <span className="text-indigo-600">Oscar Tellez?</span>
                </h2>
                <p className="mt-2 text-sm text-gray-500 md:text-base">
                  Comencé en el mundo de la tecnología en 2018 con la plataforma
                  de platzi cursos online, ahí fui adquiriendo nuevos
                  conocimientos como Javascript e introducción a Machine
                  Learning entre otras tecnologías, posteriormente entre al
                  programa Platzi Master en el 2020 y me especialice como
                  Frontend Developer trabajando con CSS, HTML, JAVASCRIPT,
                  REACT.JS. actualmente me encuentro estudiando para poder ser
                  Data Science y Python Dev.
                </p>
              </div>
            </div>
            ...
            <div className="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/3">
              ...
              <article className="overflow-hidden rounded-lg shadow-lg">
                ...
                <header className="flex items-center justify-between leading-tight p-2 md:p-4">
                  ...
                  <p className="text-grey-darker text-sm">25/02/2021</p>
                </header>
                <article className="flex items-center justify-between leading-none p-2 md:p-4">
                  <p>
                    Mi pagina web fue creada con tecnologias de html y css y
                    javascript utilizando el framework de TAILWINDCSS y el
            ...
            <div className="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/3">
              ...
              <article className="overflow-hidden rounded-lg shadow-lg">
                ...
                <header className="flex items-center justify-between leading-tight p-2 md:p-4">
                  ...
                  <p className="text-grey-darker text-sm">21/09/2020</p>
                </header>
                <article className="flex items-center justify-between leading-none p-2 md:p-4">
                  <p>
                    Esta aplicacion web fue creada con tecnologias de React.js
                    asi como una API con flask fue creada para el proyecto final
                    de platzi master junto a mi grupo de compañeros de cohort
                  </p>
                </article>
                <footer className="flex items-center justify-between leading-none p-2 md:p-4">
                  <a
                  ...
                  >
                    <img
                      ...
                      src="/web.png"
                    />
                    <p className="ml-2 text-sm">Master platzi Cohort 5</p>
                  </a>
                  <a
                    className="no-underline text-grey-darker hover:text-red-dark"
                    href="#"
            ...
            <div className="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/3">
              ...
              <article className="overflow-hidden rounded-lg shadow-lg">
                ...
                <header className="flex items-center justify-between leading-tight p-2 md:p-4">
                  ...
                  <p className="text-grey-darker text-sm">29/09/2020</p>
                </header>
                <article className="flex items-center justify-between leading-none p-2 md:p-4">
                  <p>
                    Esta pagina web fue creada con html y el framework boostrap
                    y pretende crear una web sobre videojuegos fue un proyecto
                    de platzi master
                  </p>
                </article>
                <footer className="flex items-center justify-between leading-none p-2 md:p-4">
                  ...
                  >
                    <img
                      ...
                      src="/web.png"
                    />
                    <p className="ml-2 text-sm">Platzi Master Cohort 5</p>
                  </a>
                  <a
                    className="no-underline text-grey-darker hover:text-red-dark"
                    href="#"
        ...
        <article>
          ...
          <div className="mt-10 text-center">
            ...
            <p className="text-lg">
              Las tecnologias que trabajo actualmente son HTML | CSS |
              JAVASCRIPT | NEXT.JS | REACT.JS | TAILWINDCSS | PYTHON | DJANGO |
              FLASK |
            </p>
          </div>
        </article>
            ...
            <div className="bg-white lg:mx-8 lg:flex lg:max-w-5xl lg:shadow-lg lg:rounded-lg">
              ...
              <div className="py-12 px-6 max-w-xl lg:max-w-5xl lg:w-1/2">
                <h2 className="text-3xl text-gray-800 font-bold">
                  Un Poco de <span className="text-indigo-600">Mi</span>
                </h2>
                <p className="mt-4 text-gray-600">
                  Soy un apasionado de la Tecnologia me gusta mucho aprender
                  cosas nuevas. Me gusta leer y ademas jugar en la pc, mi
                  deporte favorito es el futbol americano mi equipo los
                  patriotas de nueva inglaterra, ademas de aprender todo sobre
                  front una de mis metas a largo plazo es ser Data Science.
                </p>
                {/* <div className="mt-8">
            ...
            <div className="sm:flex mb-4 text-white">
              ...
              <div className="sm:w-1/4 h-auto sm:mt-0 mt-8">
                <div className="text-blue mb-2">
                  Links a Tecnologias Data Science
                </div>
                <ul className="list-reset leading-normal">
                  ...
                  <li className="hover:text-blue text-grey-darker">
                    <a href="https://spark.apache.org/">Spark apache</a>
                  </li>
                </ul>

                <div className="text-blue-light mb-2 mt-4">
                  Links a Tecnologias Python
                </div>
                <ul className="list-reset leading-normal">
                  <li className="hover:text-blue-light text-grey-darker">
                    <a href="https://www.cocos.com/en/">Cocos2d</a>
                  </li>
                  <li className="hover:text-blue-light text-grey-darker">
              ...
              <div className="sm:w-1/4 h-auto sm:mt-0 mt-8">
                <div className="text-green-dark mb-2">
                  Link a mi repositorio de Git Hub
                </div>
                <ul className="list-reset leading-normal">
                  <li className="hover:text-green-dark text-grey-darker">
                    <a href="https://github.com/OscarAT1984">Mi GitHub</a>
                  </li>
                </ul>
              </div>
        ...
        <div className="flex items-center justify-between my-4 bg-gray-800">
          ...
          <p className="inline-flex text-white px-2 pt-6">
            Por Oscar Armando Tellez Covarrubias.
          </p>
